...
const TOAST_DEPS = [
  ['/platforms/' + process.env.UNI_PLATFORM + '/components/app/popup/toast.vue', 'Toast'],
  ['/platforms/' + process.env.UNI_PLATFORM + '/components/app/popup/mixins/toast.js', 'ToastMixin']
]

// TODO 暂不考虑 head,tabBar 的动态拆分
const DEPS = {
  chooseLocation: [
    ['/platforms/' + process.env.UNI_PLATFORM + '/view/components/map/index.vue', 'Map'],
    ['/core/view/components/input/index.vue', 'Input'],
    ['/core/view/components/scroll-view/index.vue', 'ScrollView'],
    ['/platforms/' + process.env.UNI_PLATFORM + '/service/api/network/request.js', 'request'],
    ['/platforms/' + process.env.UNI_PLATFORM + '/service/api/location/get-location.js', 'getLocation'],
    ['/platforms/' + process.env.UNI_PLATFORM + '/components/system-routes/choose-location/index.vue', 'ChooseLocation']
  ],
  openLocation: [
    ['/platforms/' + process.env.UNI_PLATFORM + '/view/components/map/index.vue', 'Map'],
    ['/platforms/' + process.env.UNI_PLATFORM + '/service/api/network/request.js', 'request'],
    ['/platforms/' + process.env.UNI_PLATFORM + '/service/api/location/get-location.js', 'getLocation'],
    ['/platforms/' + process.env.UNI_PLATFORM + '/components/system-routes/open-location/index.vue', 'OpenLocation']
  ],
  getLocation: [
    ['/platforms/' + process.env.UNI_PLATFORM + '/service/api/network/request.js', 'request']
  ],
  previewImage: [
    ...
    [
      '/platforms/' + process.env.UNI_PLATFORM + '/components/app/popup/preview-image/index.vue',
      'PreviewImage'
    ],
    [
      '/platforms/' + process.env.UNI_PLATFORM + '/components/app/popup/mixins/preview-image.js',
      'PreviewImageMixin'
    ]
  ],
  ...
  showModal: [
    ['/platforms/' + process.env.UNI_PLATFORM + '/components/app/popup/modal.vue', 'Modal'],
    ['/platforms/' + process.env.UNI_PLATFORM + '/components/app/popup/mixins/modal.js', 'ModalMixin']
  ],
  showActionSheet: [
    ['/platforms/' + process.env.UNI_PLATFORM + '/components/app/popup/actionSheet.vue', 'ActionSheet'],
    ['/platforms/' + process.env.UNI_PLATFORM + '/components/app/popup/mixins/action-sheet.js', 'ActionSheetMixin']
  ],
  createSelectorQuery: [
