...
const extendsApiPath = path.resolve(__dirname, '../lib/' + process.env.UNI_PLATFORM + '/extends-api')
  ...
  return {
    resolve: {
      alias: {
        ...
        'uni-platform-api': path.resolve(__dirname, '../src/platforms/' + process.env.UNI_PLATFORM + '/service/api'),
      ...
      rules: [{
        ...
        use: [{
          ...
          options: {
            ...
            platform: path.resolve(__dirname, '../src/platforms/' + process.env.UNI_PLATFORM + '/view/components')
          }
        }]
      }, {
        test: path.resolve(__dirname, '../src/platforms/' + process.env.UNI_PLATFORM + '/service/api/index.js'),
        use: [{
          loader: path.resolve(__dirname, '../lib/extends-api-loader'),
          options: {
            extends: path.resolve(pluginDir, 'src/service/api'),
            base: path.resolve(__dirname, '../src/platforms/' + process.env.UNI_PLATFORM + '/service/api')
          }
        }]
      }]
    }
