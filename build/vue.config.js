...
if ((process.env.UNI_PLATFORM === 'h5' || process.env.UNI_PLATFORM === 'hos') && process.env.UNI_UI === 'true') {
...
if (process.env.UNI_PLATFORM === 'h5' || process.env.UNI_PLATFORM === 'hos') { postCssConfig.plugins.push(splitMediaPlugin) }
...
module.exports = {
  ...
  parallel: (process.env.UNI_PLATFORM !== 'h5' && process.env.UNI_PLATFORM !== 'hos') || process.env.UNI_WATCH !== 'false' || process.env.UNI_UI === 'true',
  chainWebpack: config => {
