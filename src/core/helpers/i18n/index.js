...
if (__PLATFORM__ === 'h5' || __PLATFORM__ === 'app-plus' || __PLATFORM__ === 'hos') {
...
if (__PLATFORM__ === 'h5' || __PLATFORM__ === 'hos') {
...
export const i18n = initVueI18n(
  locale,
  __PLATFORM__ === 'app-plus' || __PLATFORM__ === 'h5' || __PLATFORM__ === 'hos' ? messages : {}
)
