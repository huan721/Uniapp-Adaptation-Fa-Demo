  ...
  api.extendPackage(pkg => {
    ...
    return {
      scripts: {
        ...
        'dev:hos': 'cross-env NODE_ENV=development UNI_PLATFORM=hos vue-cli-service uni-serve',
        ...
        'build:hos': 'cross-env NODE_ENV=production UNI_PLATFORM=hos vue-cli-service uni-build',
